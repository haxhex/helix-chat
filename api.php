...
}elseif(isset($DATA_OBJ->data_type) && $DATA_OBJ->data_type == "edit_message")
{
	 //edit message
...
function message_right($data,$row)
{
	...
	$a .= "</div>
		...
		$a .= "<span style='font-size:11px;color:#888;'>".date("M Y H:i:s a",strtotime($data->date))."<span>
		<br><br>
		"."<a style='text-decoration:none;color:black;' href='includes/edit_message.php?id=$data->id'>Edit</a>
		<img id='trash' src='ui/icons/trash.png' onclick='delete_message(event)' msgid='$data->id' />
	</div>";
