			...
			.dragging{
				border: dashed 2px #aaa;
		 		...
		 		<div style="display:flex;animation: appear 1s ease">
		 			...
		 			<label for="change_image_input" id="change_image_button" style="background-color:#9b9a80;display:table;margin:auto;padding:1em;border-radius:5px;cursor:pointer;">
		 				Change Image
		 			</label>
